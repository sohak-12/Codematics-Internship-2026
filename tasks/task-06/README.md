...
1.  **Download:** Access the main repository ZIP or clone it via Git.
2.  **Navigate:** Go to `Tasks/Task 06/src/`.
3.  **Launch:** Open `index.html` in your browser (Live Server is recommended for the best experience).
4.  **Note:** Ensure the `../images/` directory is properly linked so that profile photos and technology icons render correctly.
